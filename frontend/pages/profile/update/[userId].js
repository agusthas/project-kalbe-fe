...
const UpdateProfile = ({ user }) => {
  ...
  const [confirmationPasswordAlert, setConfirmationPasswordAlert] =
    useState("");
  ...
  const updateHandler = (e) => {
    ...
    updateMe(updatedUser, session.accessToken)
      .then((response) => {
      ...
      <Container className="px-0 py-5">
        ...
        <Form className="w-50 mx-auto py-3" onSubmit={updateHandler}>
          ...
          <Form.Group className="py-3">
            <Form.Label htmlFor="avatar" className="w-25">
              Profile Picture URL
            </Form.Label>
            <Form.Control
          ...
          <Form.Group className="py-3">
            <Form.Label htmlFor="name" className="w-25">
              Name
            </Form.Label>
            <Form.Control
          ...
          {nameAlert && (
            <p
              id="title"
              className="d-flex flex-column text-center text-danger p-2 m-1"
              style={{ borderRadius: "10px", backgroundColor: "#ffc7d0" }}
            >
              {nameAlert}
            </p>
          )}
          <Form.Group className="py-3">
            <Form.Label htmlFor="email" className="w-25">
              Email
            </Form.Label>
            <Form.Control
          ...
          <div className="d-flex justify-content-between">
            <Form.Group className="py-3 w-50">
              <Form.Label htmlFor="password" className="w-50">
                Password
              </Form.Label>
              <Form.Control
            ...
            {passwordAlert && (
              <p
                id="title"
                className="w-50 d-flex flex-column text-center text-danger p-2 m-1"
                style={{ borderRadius: "10px", backgroundColor: "#ffc7d0" }}
              >
                {passwordAlert}
              </p>
            ...
            <Form.Group className="py-3 w-50 mx-2">
              <Form.Label htmlFor="password_confirmation" className="w-50">
                Confirm Password
              </Form.Label>
              <Form.Control
          ...
          <Form.Group className="py-3">
            <Form.Label htmlFor="phone" className="w-25">
              Phone Number
            </Form.Label>
            <Form.Control
          ...
          <Form.Group className="py-3">
            <Form.Label htmlFor="bio" className="w-25">
              Bio
            </Form.Label>
            <Form.Control
          ...
          {bioAlert && (
            <p
              id="title"
              className="d-flex flex-column text-center text-danger p-2 mb-4"
              style={{ borderRadius: "10px", backgroundColor: "#ffc7d0" }}
            >
              {bioAlert}
            </p>
          ...
          <div className="d-flex justify-content-end">
            <div className="d-flex justify-content-between w-25">
              <Link href={`/profile/view/${session.user.id}`}>
                <Button className="btn text-white btn-danger fw-bold">
                  Cancel
                </Button>
              </Link>
